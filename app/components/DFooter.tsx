...
const Footer: React.FC = () => {
  return (
    <footer className="mt-10 py-6 border-t border-gray-200 text-center text-sm text-gray-600 bg-slate-900">
      <p className="flex justify-center items-center gap-1 text-gray-200">
